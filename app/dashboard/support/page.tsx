      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width="clamp(56px, 16vw, 64px)" height="clamp(56px, 16vw, 64px)" viewBox="0 0 64 64" fill="none" style={{ margin: "0 auto", marginBottom: spacing.sm }}>
            ...
            <path d="M32 20C26.5 20 22 24.5 22 30C22 32 22.5 33.8 23.5 35.3M32 20C37.5 20 42 24.5 42 30C42 32 41.5 33.8 40.5 35.3M32 20V14M28 30H36M32 30V38" stroke={colors.dark} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M23.5 35.3C24.5 36.8 26 38 28 38.5M40.5 35.3C39.5 36.8 38 38 36 38.5" stroke={colors.dark} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <div style={{
            fontSize: fontSize.lg,
            fontWeight: 700,
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: spacing.xs }}>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: spacing.sm }}>
                ...
                <span style={{ fontSize: fontSize.sm }}>سوالات متداول</span>
              </div>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M15 19L8 12L15 5" stroke={colors.muted} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: spacing.sm }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M12 16V12M12 8H12.01" stroke={colors.primary} strokeWidth="2" strokeLinecap="round"/>
                </svg>
                <span style={{ fontSize: fontSize.sm }}>اطلاعات حساب کاربری</span>
              </div>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M15 19L8 12L15 5" stroke={colors.muted} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
